...
class AdminAddCategoryPage(BaseWrapper):
    ...
    def __init__(self, driver):
        ...
        self.ctg_name_inp = InputElement(self.CTG_INP_FIELD_CSS)
        self.row_index = TableElement(self.COLUMN_OF_TABLE_CSS, self.driver)
        self.edit_ctg_btn = ButtonElement(self.CTG_EDIT_BTN_CSS)
        self.cancel_ctg_btn = ButtonElement(self.CTG_CANCEL_BTN_CSS)
        self.delete_ctg_btn = ButtonElement(self.CTG_DELETE_BTN)
