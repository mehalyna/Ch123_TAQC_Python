...
class NotificationPage:
    ...
    def subject_clear_notification_field(self):
        ...
        """
        element = self.driver.find_element(By.CSS_SELECTOR, MESSAGE_NOTIFICATION_FIELD_CSS)
    ...
    def subject_notification_field(self, subject_text):
        ...
        """
        self.driver.find_element(By.CSS_SELECTOR, SUBJECT_NOTIFICATION_FIELD_CSS).send_keys(subject_text)
    ...
    def save_reset_btns_track(self, btn_name):
        """
            Method for click search or reset button.
                Available input for btn_name:
