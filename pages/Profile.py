...
class ProfilePage:
    ...
    def click_expansion_panel(self, expansion_panel_number):
        """
            Method for click on a needed expansion_panel button
    ...
    def change_gender_option(self, option):
        ...
        dropdown1.select_by_visible_text(option)
    ...
    def click_favorite_categories_save_btn(self, categories):
        """
           Method for choosing_favorite_categories
        """
        element = self.driver.find_element(By.CSS_SELECTOR, self.FAVORITE_CATEGORIES_SAVE_BTN_CSS)
        element.click()
    ...
    def click_password_submit_btn(self):
        """
    ...
    def click_password_clear_btn(self):
        """
           Method for clear all change password fields
        """
    ...
    def click_date_of_birth_clear_btn(self):
        """
            Method to click clear button on expansion panel date of birth
        """
        element = self.driver.find_element(By.CSS_SELECTOR, self.DATE_OF_BIRTH_CLEAR_BTN_CSS)
        element.click()

    def click_date_of_birth_submit_btn(self):
        """
            Method to click clear button on expansion panel date of birth
        """
        element = self.driver.find_element(By.CSS_SELECTOR, self.DATE_OF_BIRTH_SUBMIT_BTN_CSS)
        element.click()
