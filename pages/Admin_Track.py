...
class Track:
    ...
    def info_track_btn(self, track_index):
        ...
        INFO_BTN_TRACK_CSS = f'tr:nth-child({track_index}) > td:nth-child(5) > div > button'
        self.driver.find_element(By.CSS_SELECTOR, INFO_BTN_TRACK_CSS).click()

    def entity_name_field_track(self, search_text):
        """Entity name input method"""
        self.driver.find_element(By.CSS_SELECTOR, ENTYTY_NAME_FIELD_TRACK_CSS).send_keys(
            f'{search_text}')
    ...
    def from_date_track(self, date):
        ...
        self.driver.find_element(By.CSS_SELECTOR, FROM_DATE_FIELD_TRACK_CSS).send_keys(f'{date}')

    def to_date_track(self, date):
        """Method for input date 'to' creating"""
        return self.driver.find_element(By.CSS_SELECTOR, TO_DATE_FIELD_TRACK_CSS).send_keys(f'{date}')

    def search_track(self):
        """Method for clicking search search button"""
        return self.driver.find_element(By.CSS_SELECTOR, SEARCH_BTN_TRACK_CSS).click()

    def reset_track(self):
        """Method for clicking reset button"""
        return self.driver.find_element(By.CSS_SELECTOR, RESET_BTN_TRACK_CSS).click()
